...
(function () {
  const TEASER_REVEAL_AT = new Date('2026-09-14T16:40:00'); // <-- change this to whenever the sneak peek should unlock
...
const letterCloseBtn = document.getElementById('teaserLetterCloseBtn');
